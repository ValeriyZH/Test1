...
def test_all_fields_request_temporary_pass(browser):
    ...
    Base.element_exists_and_send(browser, S.xpath_last_name_RP, D.last_name)
    Base.element_exists_and_send(browser, S.xpath_first_name_RP, D.first_name)
    Base.element_exists_and_send(browser, S.xpath_middle_name_RP, D.middle_name)
